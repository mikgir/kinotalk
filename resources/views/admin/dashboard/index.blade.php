	  ...
	  <div class="col-xxl-4 col-sm-6 box-col-6">
		<div class="card profile-box">
		  <div class="card-body">
			...
			<div class="cartoon"><img class="img-fluid" src="{{ asset('assets/admin/images/dashboard/cartoon.svg') }}" alt="vector women with leptop"></div>
		  </div>
		</div>
	  </div>
			  ...
			  <div class="card-body">
				<div class="widget-content">
				  <div class="widget-round secondary">
					<div class="bg-round">
					  <svg class="svg-fill">
						<use href="{{ asset('assets/admin/svg/icon-sprite.svg#cart') }}"> </use>
					  </svg>
				...
				<div class="card-body">
				  <div class="widget-content">
					<div class="widget-round primary">
					  <div class="bg-round">
						<svg class="svg-fill">
						  <use href="{{ asset('assets/admin/svg/icon-sprite.svg#tag') }}"> </use>
						</svg>
						<svg class="half-circle svg-fill">
						  <use href="{{ asset('assets/admin/svg/icon-sprite.svg#halfcircle') }}"></use>
						</svg>
			  ...
			  <div class="card-body">
				<div class="widget-content">
				  <div class="widget-round warning">
					<div class="bg-round">
					  <svg class="svg-fill">
						<use href="{{ asset('assets/admin/svg/icon-sprite.svg#return-box') }}"> </use>
					  </svg>
					  <svg class="half-circle svg-fill">
						<use href="{{ asset('assets/admin/svg/icon-sprite.svg#halfcircle') }}"></use>
					  </svg>
				...
				<div class="card-body">
				  <div class="widget-content">
					<div class="widget-round success">
					  <div class="bg-round">
						<svg class="svg-fill">
						  <use href="{{ asset('assets/admin/svg/icon-sprite.svg#rate') }}"> </use>
						</svg>
						<svg class="half-circle svg-fill">
						  <use href="{{ asset('assets/admin/svg/icon-sprite.svg#halfcircle') }}"></use>
						</svg>
				...
				<div class="row g-sm-4 g-2">
				  <div class="col-xl-12 col-md-4">
					<div class="light-card balance-card widget-hover">
					  <div class="svg-box">
						<svg class="svg-fill">
						  <use href="{{ asset('assets/admin/svg/icon-sprite.svg#income') }}"></use>
						</svg>
					  </div>
				  ...
				  <div class="col-xl-12 col-md-4">
					<div class="light-card balance-card widget-hover">
					  <div class="svg-box">
						<svg class="svg-fill">
						  <use href="{{ asset('assets/admin/svg/icon-sprite.svg#expense') }}"></use>
						</svg>
					  </div>
				  ...
				  <div class="col-xl-12 col-md-4">
					<div class="light-card balance-card widget-hover">
					  <div class="svg-box">
						<svg class="svg-fill">
						  <use href="{{ asset('assets/admin/svg/icon-sprite.svg#doller-return') }}"></use>
						</svg>
					  </div>
			...
			<div class="card-body pt-0">
			  <div class="appointment-table table-responsive">
				<table class="table table-bordernone">
				  <tbody>
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('assets/admin/images/dashboard/user/1.jpg') }}" alt="user"></td>
{{--					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Jane Cooper</a><span class="f-light">10 minutes ago</span></td>--}}
					...
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('assets/admin/images/dashboard/user/2.jpg') }}" alt="user"></td>
{{--					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Brooklyn Simmons</a><span class="f-light">19 minutes ago</span></td>--}}
					...
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('admin/images/dashboard/user/3.jpg') }}" alt="user"></td>
{{--					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Leslie Alexander</a><span class="f-light">2 hours ago</span></td>--}}
					...
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('admin/images/dashboard/user/4.jpg') }}" alt="user"></td>
{{--					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Travis Wright</a><span class="f-light">8 hours ago</span></td>--}}
					...
					<tr>
					  <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('admin/images/dashboard/user/5.jpg') }}" alt="user"></td>
{{--					  <td class="img-content-box"><a class="d-block f-w-500" href="{{ route('user-profile')}}">Mark Green</a><span class="f-light">1 day ago</span></td>--}}
	  ...
	  <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
		<div class="card purchase-card"><img class="img-fluid" src="{{ asset('assets/admin/images/dashboard/purchase.png') }}" alt="vector mens with leptop">
	  ...
	  <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
		<div class="card papernote-wrap">
		  ...
		  <div class="card-body pt-0"> <img class="banner-img img-fluid" src="{{ asset('assets/admin/images/dashboard/papernote.jpg') }}" alt="multicolor background">
			<div class="note-content mt-sm-4 mt-2">
			  ...
			  <div class="mt-sm-4 mt-2 user-details">
				<div class="customers">
				  <ul>
					<li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/admin/images/dashboard/user/1.jpg') }}" alt="user"></li>
					<li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/admin/images/dashboard/user/6.jpg') }}" alt="user"></li>
					<li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/admin/images/dashboard/user/7.jpg') }}" alt="user"></li>
					<li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/admin/images/dashboard/user/3.jpg') }}" alt="user"></li>
					<li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/admin/images/dashboard/user/8.jpg') }}" alt="user"></li>
