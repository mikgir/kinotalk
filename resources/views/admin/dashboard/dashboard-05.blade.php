        ...
        <div class="row">
          ...
          <div class="col-xl-12 col-md-6">
            <div class="card mobile-app-card">
              ...
              <div class="card-body p-0 text-end"><img class="wavy" src="{{ asset('assets/images/dashboard-5/wave.png') }}" alt=""><img src="{{ asset('assets/images/dashboard-5/mobile-images.png') }}" alt=""></div>
            </div>
          </div>
        </div>
      </div>
