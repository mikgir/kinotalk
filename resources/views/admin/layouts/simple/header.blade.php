...
{{--      <div class="logo-wrapper"><a href="{{ route('index')}}"><img class="img-fluid" src="{{ asset('assets/images/logo/logo.png') }}" alt=""></a></div>--}}
    ...
    <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
      <div class="notification-slider">
        <div class="d-flex h-100"> <img src="{{ asset('assets/admin/images/giftools.gif') }}" alt="gif">
    ...
    <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          <svg>
            <use href="{{ asset('admin/svg/icon-sprite.svg#star') }}"></use>
          </svg>
        ...
        <li class="cart-nav onhover-dropdown">
          <div class="cart-box">
            <svg>
              <use href="{{ asset('admin/svg/icon-sprite.svg#stroke-ecommerce') }}"></use>
          ...
          <div class="cart-dropdown onhover-show-div">
            ...
            <ul>
              <li>
                <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('admin/images/other-images/cart-images.jpg') }}" alt="">
