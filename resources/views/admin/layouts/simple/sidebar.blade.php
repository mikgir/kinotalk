...
{{--                                                <li><a href="{{ route('comingsoon-bg-images')}}">Coming with Bg Image</a></li>--}}
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col mega-box">
...
{{--                            <li><a href="{{ route('job-apply')}}">Apply</a></li>--}}
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                            <svg class="stroke-icon">
                                <use href="{{ asset('admin/svg/icon-sprite.svg#stroke-learning') }}"></use>
                            </svg>
                            <svg class="fill-icon">
                                <use href="{{ asset('admin/svg/icon-sprite.svg#fill-learning') }}"></use>
...
{{--                            <li><a href="{{ route('learning-detailed')}}">Detailed Course</a></li>--}}
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                            ...
                            <svg class="fill-icon">
                                <use href="{{ asset('admin/svg/icon-sprite.svg#fill-maps') }}"></use>
...
{{--                            <li><a href="{{ route('vector-map')}}">Vector Maps</a></li>--}}
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                            <svg class="stroke-icon">
                                <use href="{{ asset('admin/svg/icon-sprite.svg#stroke-editors') }}"></use>
                            </svg>
                            <svg class="fill-icon">
